...
from apps import home, msmes_online, support, challenges, digitech_adoption
...
apps = [
         ...
         {"func": digitech_adoption.app, "title": "Digital Technology Adopted by MSMEs", "icon": "pc-display-horizontal"},
]
